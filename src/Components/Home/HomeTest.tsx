...
const HomeTest = () => {
    ...
    return (
        ...
        <motion.div
            ...
            className="home">
            <div className="layer" onClick={()=>{ mobileVersion && displayNone && setEventMVersion(!eventMVersion)}}></div>
            <motion.img
                    ...
                    <>
                        {!mobileVersion && (
                            ...
                            <motion.div
                                ...
                                <div className="hide-text-block">
                                    <motion.div variants={textAnimation} className="button-link-home label-hello animate">
                                        Hello.
                                    </motion.div>
                                </div >
                                <div className="hide-text-block">
                                    <motion.div variants={textAnimation} className="button-link-home label-skills text-color-red animate">
                                        I am
                                    </motion.div>
                                </div>
                                <div className="hide-text-block">
                                    <motion.div variants={textAnimation} className="button-link-home text-color-red label-contacts animate">
                                        Rostislav
                                    </motion.div>
                                </div>
                            </motion.div>)}
            ...
            <AnimatePresence>
                {contactsBox && (
                    ...
                    >
                        <Contacts/>
                        <div className="back-button" onClick={()=>{setContactsBox(false); setEventMVersion(true); setTimeout(()=>{setDisplayNone(true)},1100)}}>Back</div>
                    </motion.div>)}
            </AnimatePresence>
        </motion.div>
            )}
